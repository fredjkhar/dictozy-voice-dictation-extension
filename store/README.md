...
- `listing.md`: draft listing copy, privacy declarations, permission justifications, and reviewer notes.
...
The public privacy policy source is `../PRIVACY.md`. Host it at a stable public HTTPS URL before submission and enter that URL in the Developer Dashboard Privacy tab.
