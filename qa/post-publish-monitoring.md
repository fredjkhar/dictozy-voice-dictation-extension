...
7. Confirm clicking the microphone button starts recording and Chrome's microphone permission flow is respected.
...
14. Confirm the popup shows the assigned browser shortcut or `Not assigned`.
